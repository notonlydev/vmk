	...
	<div class="container">
		<div class="diagnostics_tabs">
			<div class="diagnostics_send">
				...
				<p>
					 Лучшее лечение болезни - это ее предотвращение, вернее, профилактика. Для поддержания здоровья десен и зубов, нужно минимум дважды в год проходить осмотр у врача-стоматолога, правильно питаться, чистить зубы минимум дважды в день
				</p>
			...
			<form class="feedback" method="POST" id="form1">
                        <div class="from_item">
                            <div class="from_item_input">
                                <label for="feed_name">Ваше имя</label>
                                <input id="feed_name" type="text" name="name" placeholder="Ваше имя" required>
                                <label for="feed_email">Почта</label>
                                <input id="feed_email" type="email" name="email" placeholder="Почта" required>
                            </div>
                            <textarea placeholder="Ваш вопрос" required rows="4" name="question"></textarea>
                        </div>
...
<div class="content_block reviews_block">
	...
	false
		...
		<form class="reviews_feedback" action="#">
			<div class="from_item">
				<div class="from_item_input">
 <label for="reviews_name">Ваше имя</label> <input id="reviews_name" type="text" name="reviews_name" placeholder="Ваше имя" required=""> <label for="reviews_email">Почта</label> <input id="reviews_email" type="email" name="reviews_email" placeholder="Почта" required="">
				</div>
	...
	<div class="container">
		...
		<div class="block_layout">
			<ul class="treatment_list">
				...
				<li>
				<p>
					 Реакция на холод, кислое, горячее
				</p>
 </li>
				<li>
				<p>
					 Внешне здоровый зуб стал шататься
				</p>
 </li>
				<li>
				<p>
...
<div class="content_block map_block">
	...
	<div class="container">
		<div class="map_address">
			<p>
				 Контакты нашего<br>
				 офиса в С-Петербургe
			</p>
			<ul class="map_address_list">
				<li>Санкт-Петербург, Владимирский проеспект</li>
				<li>с 10:00-22:00</li>
				<li>+7(812) 123-45-67</li>
			</ul>
			<ul class="map_address_social">
				<li class="vk_soc"> <a href="#">Вконтакте</a> </li>
				<li class="insta_soc"> <a href="#">Инстаграм</a> </li>
			</ul>
...
<script type="text/javascript">
        $(document).ready(function () {
            $('form').submit(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/<?=SITE_TEMPLATE_PATH?>/mail.php', // Обработчик формы отправки
